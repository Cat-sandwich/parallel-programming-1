...
if __name__ == "__main__":
    list_size = [ 50, 100, 500, 600, 700, 800, 900, 1000]
    list_folder_name = ["E:\УЧЕБА\\parallel programming\\lab1\\lab_1\\VS\\data_matrix_1\\", "E:\\УЧЕБА\\parallel programming\\lab1\\lab_1\\VS\\data_matrix_2\\",
    ...
    for i in list_size:
        ...
        c = read(list_folder_name[2] + str(i) + "_0"  + ".txt", c)
        list_res_check.append(np.array_equal(res, c))

    f1 = open("E:\УЧЕБА\\parallel programming\\lab1\\lab_2\\VS\\res_check.txt", "w+")
